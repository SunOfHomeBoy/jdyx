// Copyright 2018 The Haohaoxiuche Team Authors. All right reserved.
...
export function Initialization(configures) {
        ...
        function styleSheets(configures) {
                ...
                if (ua.indexOf('Edge') !== -1) {
                        buffers.push('h-browser-engine-edge')

                } else if (ua.indexOf('Trident') !== -1) {
                        buffers.push('h-browser-engine-trident')

                } else if (ua.indexOf('AppleWebKit') !== -1) {
                        buffers.push('h-browser-engine-webkit')

                } else if (ua.indexOf('Gecko') !== -1) {
                        buffers.push('h-browser-engine-gecko')
                }

                if (ua.indexOf('Edge') !== -1) {
                        buffers.push('h-browser-agent-edge')

                } else if (ua.indexOf('Trident') !== -1) {
                        let ie = ua.indexOf('IE') === -1 ?
                                'h-browser-agent-ie1x' :
                                'h-browser-agent-ie'
                        buffers.push(ie)

                } else if (ua.indexOf('Opera') !== -1) {
                        buffers.push('h-browser-agent-opera')

                } else if (ua.indexOf('Firefox') !== -1) {
                        buffers.push('h-browser-agent-firefox')

                } else if (ua.indexOf('Chrome') !== -1) {
                        buffers.push('h-browser-agent-chrome')

                } else if (ua.indexOf('Safari') !== -1) {
                        buffers.push('h-browser-agent-safari')

                } else {
                        buffers.push('h-browser-agent-default')
                }

                if (platform.indexOf('Win') !== -1) {
                        buffers.push('h-browser-platform-windows')

                } else if (platform.indexOf('Mac') !== -1) {
                        buffers.push('h-browser-platform-mac')

                } else if (platform.indexOf('Linux') !== -1) {
                        buffers.push('h-browser-platform-linux')

                } else {
                        buffers.push('h-browser-platform-default')
                }

                if (ua.indexOf('MicroMessenger') !== -1) {
                        buffers.push('h-browser-device-wechat')

                } else if (ua.match(/(iPhone|iPod|Android|ios)/i)) {
                        buffers.push('h-browser-device-mobile')

                } else if (ua.indexOf('Xbox') !== -1) {
                        buffers.push('h-browser-device-xbox')

                } else {
                        buffers.push('h-browser-device-default')
                }
