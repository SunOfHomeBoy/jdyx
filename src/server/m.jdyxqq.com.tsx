...
//
/// <reference path="./m.jdyxqq.com.d.tsx" />
...
export default class WebRender {
        private static readonly platform: string = 'Mobile'
        private static readonly appname: string = 'm.jdyxqq.com'
        ...
        private app(): express.Express {
                ...
                app.use((req: express.Request, res: express.Response, next: any) => {
                        ...
                        return WebRender.controller(req, res, {
                                jdyxCountry: cookies.jdyxCountry,
                                jdyxLanguage: cookies.jdyxLanguage
                        })
                })
